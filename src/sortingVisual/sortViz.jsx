...
export default class SortingVisualizer extends React.Component{
    ...
    resetArray() {
        const unsortedArray = []; 
        for (let i = 0; i < 200; i++){ // Literally iterate through 100 random values and store them in the array intialized in the array.
            unsortedArray.push(Math.floor(Math.random()*(700 - 5 + 1)));
        }
